...
VALUES (21, 'Quel roman de Mary Shelley est un pilier du genre gothique ?',
        'Le roman "Frankenstein" de Mary Shelley est considéré comme l’un des premiers romans de science-fiction et un pilier du genre gothique. Il explore les thèmes de la création, de la responsabilité et de l’horreur.', 'CLASSIC');
...
VALUES (22, 'Quel auteur a popularisé la figure du vampire dans la littérature gothique ?',
        'Bram Stoker est l’auteur du roman "Dracula", qui a popularisé la figure du vampire dans la littérature gothique. Son œuvre a eu une influence majeure sur la représentation des vampires dans la culture populaire.', 'CLASSIC');
INSERT INTO classic_answers (id, text, is_correct, question_id)
...
VALUES (23, 'Quel roman d’Ann Radcliffe est célèbre pour ses descriptions de paysages inquiétants ?',
        'Les "Mystères d’Udolpho" d’Ann Radcliffe est célèbre pour ses descriptions de paysages inquiétants et ses atmosphères mystérieuses. Ce roman est un exemple emblématique du genre gothique.', 'CLASSIC');
INSERT INTO classic_answers (id, text, is_correct, question_id)
...
VALUES (24, 'Quel est le nom du protagoniste principal dans "Dracula" de Bram Stoker ?',
        'Le protagoniste principal dans "Dracula" de Bram Stoker est Jonathan Harker. Il est un jeune avocat qui se rend en Transylvanie pour aider le comte Dracula à acheter une propriété en Angleterre.', 'CLASSIC');
INSERT INTO classic_answers (id, text, is_correct, question_id)
...
VALUES (25, 'Quel roman gothique se déroule principalement en Italie ?',
        'Les "Mystères d’Udolpho" d’Ann Radcliffe se déroule principalement en Italie. Ce roman est connu pour ses paysages pittoresques et ses châteaux mystérieux.', 'CLASSIC');
INSERT INTO classic_answers (id, text, is_correct, question_id)
...
VALUES (26, 'Quel est le principal antagoniste dans "Le Moine" de Matthew Lewis ?',
        'Le principal antagoniste dans "Le Moine" de Matthew Lewis est le Diable. Ce roman est connu pour ses thèmes sombres et ses explorations de la corruption morale.', 'CLASSIC');
INSERT INTO classic_answers (id, text, is_correct, question_id)
...
VALUES (27, 'Quel auteur a écrit "Le Château d’Otrante" ?',
        'Horace Walpole est l’auteur de "Le Château d’Otrante", souvent considéré comme le premier roman gothique. Il a établi de nombreux tropes du genre, tels que les châteaux hantés et les événements surnaturels.', 'CLASSIC');
INSERT INTO classic_answers (id, text, is_correct, question_id)
...
VALUES (28, 'Quel motif architectural est omniprésent dans les romans gothiques ?',
        'Les châteaux sont un motif architectural omniprésent dans les romans gothiques. Ils servent souvent de cadre pour des événements mystérieux et surnaturels.', 'CLASSIC');
INSERT INTO classic_answers (id, text, is_correct, question_id)
...
VALUES (29, 'Dans quel roman trouve-t-on le personnage de Manfred ?',
        'Le personnage de Manfred est le protagoniste du roman "Le Château d’Otrante" d’Horace Walpole. Il est un noble tourmenté par des événements surnaturels dans son château.', 'CLASSIC');
INSERT INTO classic_answers (id, text, is_correct, question_id)
...
VALUES (30, 'Quel roman gothique a été publié en 1818 ?',
        'Le roman "Frankenstein" de Mary Shelley a été publié en 1818. Il est souvent considéré comme l’un des premiers romans de science-fiction et un pilier du genre gothique.', 'CLASSIC');
INSERT INTO classic_answers (id, text, is_correct, question_id)
...
VALUES (31, 'Quel roman gothique est une satire du genre écrite par Jane Austen ?',
        'Northanger Abbey de Jane Austen est une satire du genre gothique. Bien qu’elle utilise des éléments gothiques, elle les tourne en dérision et critique les excès du genre.', 'CLASSIC');
INSERT INTO classic_answers (id, text, is_correct, question_id)
...
VALUES (32, 'Qui est l’auteur du roman "Vathek" ?',
        'William Beckford est l’auteur du roman "Vathek". Ce roman gothique, publié en 1786, est connu pour son atmosphère orientale et ses thèmes de décadence et de débauche.', 'CLASSIC');
INSERT INTO classic_answers (id, text, is_correct, question_id)
...
VALUES (33, 'Quel élément surnaturel est fréquent dans la littérature gothique ?',
        'Le surnaturel est un élément fréquent dans la littérature gothique. Il inclut des fantômes, des vampires, des démons et d’autres créatures fantastiques qui créent une atmosphère de mystère et de peur.', 'CLASSIC');
INSERT INTO classic_answers (id, text, is_correct, question_id)
...
VALUES (34, 'Quel roman met en scène le personnage d’Emily St. Aubert ?',
        'Les "Mystères d’Udolpho" d’Ann Radcliffe met en scène le personnage d’Emily St. Aubert. Ce roman est un exemple emblématique du genre gothique, avec ses paysages inquiétants et ses intrigues mystérieuses.', 'CLASSIC');
INSERT INTO classic_answers (id, text, is_correct, question_id)
...
VALUES (35, 'Quel roman gothique a inspiré de nombreux films sur la créature artificielle ?',
        'Le roman "Frankenstein" de Mary Shelley a inspiré de nombreux films sur la créature artificielle. Il explore les thèmes de la création, de la responsabilité et de l’horreur, et est considéré comme un pilier du genre gothique.', 'CLASSIC');
INSERT INTO classic_answers (id, text, is_correct, question_id)
...
VALUES (36, 'Quel auteur américain est célèbre pour ses récits gothiques et macabres ?',
        'Edgar Allan Poe est célèbre pour ses récits gothiques et macabres. Ses œuvres, telles que "Le Corbeau" et "Le Cœur révélateur", sont emblématiques du genre gothique américain.', 'CLASSIC');
INSERT INTO classic_answers (id, text, is_correct, question_id)
...
VALUES (37, 'Quel roman gothique explore la dualité du bien et du mal à travers un portrait ?',
        'Le Portrait de Dorian Gray d’Oscar Wilde explore la dualité du bien et du mal à travers un portrait. Le personnage principal, Dorian Gray, reste jeune et beau tandis que son portrait vieillit et reflète ses actions immorales.', 'CLASSIC');
INSERT INTO classic_answers (id, text, is_correct, question_id)
...
VALUES (38, 'Quel château est le décor central du roman fondateur du genre ?',
        'Le Château d’Otrante est le décor central du roman fondateur du genre gothique, écrit par Horace Walpole. Ce roman, publié en 1764, a établi de nombreux tropes du genre, tels que les châteaux hantés et les événements surnaturels.', 'CLASSIC');
INSERT INTO classic_answers (id, text, is_correct, question_id)
...
VALUES (39, 'Quel roman gothique a pour sous-titre "Le Prométhée moderne" ?',
        'Le roman "Frankenstein" de Mary Shelley a pour sous-titre "Le Prométhée moderne". Il explore les thèmes de la création, de la responsabilité et de l’horreur, et est considéré comme un pilier du genre gothique.', 'CLASSIC');
INSERT INTO classic_answers (id, text, is_correct, question_id)
...
VALUES (40, 'Quel est le rôle du décor dans la littérature gothique ?',
        'Le décor dans la littérature gothique joue un rôle crucial en créant une atmosphère de peur et de mystère. Les châteaux, les paysages sombres et les éléments surnaturels contribuent à l’ambiance inquiétante des récits gothiques.', 'CLASSIC');
INSERT INTO classic_answers (id, text, is_correct, question_id)
